...
echo "tunnel create profile_name=default tunnel_name=ralink dest_ipaddr=$OPENL2TP_SERVER_IP hello_timeout=40 \\" >> $OPENL2TP_FILE
...
echo "session create profile_name=default tunnel_name=ralink \\" >> $OPENL2TP_FILE
